            ...
            <div className="space-y-6">
              <Card className="border" style={{borderColor: '#000000'}}>
                <CardContent className="p-6 flex items-center">
                  <MapPin className="h-8 w-8 mr-4" style={{color: '#000000'}} />
                  <div>
              ...
              <Card className="border" style={{borderColor: '#000000'}}>
                <CardContent className="p-6 flex items-center">
                  <Phone className="h-8 w-8 mr-4" style={{color: '#000000'}} />
                  <div>
              ...
              <Card className="border" style={{borderColor: '#000000'}}>
                <CardContent className="p-6 flex items-center">
                  <Clock className="h-8 w-8 mr-4" style={{color: '#000000'}} />
                  <div>
          ...
          <div>
            ...
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <Input placeholder="First Name" className="border" style={{borderColor: '#000000'}} />
                <Input placeholder="Last Name" className="border" style={{borderColor: '#000000'}} />
              </div>
              <Input placeholder="Email" type="email" className="border" style={{borderColor: '#000000'}} />
              <Input placeholder="Phone Number" className="border" style={{borderColor: '#000000'}} />
              <Input placeholder="Subject" className="border" style={{borderColor: '#000000'}} />
              <Textarea placeholder="Your Message" rows={6} className="border" style={{borderColor: '#000000'}} />
              <Button 
                type="submit" 
